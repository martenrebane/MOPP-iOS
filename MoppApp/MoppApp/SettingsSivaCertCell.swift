...
class SettingsSivaCertCell: UITableViewCell {
    ...
    func populate(with field:SettingsViewController.Field) {
        ...
        sivaUrlTextField.attributedPlaceholder = NSAttributedString(string: configuration.SIVAURL, attributes: attributes)
        self.field = field
    ...
    func updateUI() {
        DispatchQueue.main.async {
            ...
            self.certificateStackView.isAccessibilityElement = false
            self.certificateDataStackView.isAccessibilityElement = false
            self.validationAccessStackView.isAccessibilityElement = false
            self.validationAccessChoiceStackView.isAccessibilityElement = false
            self.useDefaultAccessStackView.isAccessibilityElement = false
            self.useManuallyConfiguredAccessStackView.isAccessibilityElement = false
            self.certificateButtonsStackView.isAccessibilityElement = false
            
            self.setAccessibilityElementsInStackView(stackView: self.certificateStackView, isAccessibilityElement: true)
            self.setAccessibilityElementsInStackView(stackView: self.certificateDataStackView, isAccessibilityElement: true)
            self.setAccessibilityElementsInStackView(stackView: self.validationAccessStackView, isAccessibilityElement: true)
            self.setAccessibilityElementsInStackView(stackView: self.validationAccessChoiceStackView, isAccessibilityElement: true)
            self.setAccessibilityElementsInStackView(stackView: self.useDefaultAccessStackView, isAccessibilityElement: true)
            self.setAccessibilityElementsInStackView(stackView: self.useManuallyConfiguredAccessStackView, isAccessibilityElement: true)
            self.setAccessibilityElementsInStackView(stackView: self.certificateButtonsStackView, isAccessibilityElement: true)
            ...
            self.useDefaultAccessView.accessibilityUserInputLabels = ["Default access"]
            
            self.useManuallyConfiguredAccessRadioButton.accessibilityUserInputLabels = ["Manual access"]
