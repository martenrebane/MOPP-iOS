...
enum LocKey : String
{
    ...
    case infoAppContactDisplayLink = "info-app-contact-display-link"
    case infoAppContactLink = "info-app-contact-link"
    case infoAppLogoAccessibility = "info-app-logo-accessibility"
    case infoAppAdditionalLicensesLabel = "info-app-additional-licenses-label"
    ...
    case voiceControlDisableLogGeneration = "voice-control-disable-log-generation";
    case voiceControlEstonianLanguage = "voice-control-estonian-language";
