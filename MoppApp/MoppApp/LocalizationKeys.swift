...
enum LocKey : String
{
    ...
    case containerSignatureTestSignatureTitle = "container-signature-test-signature-title";
    ...
    case errorAlertNoInternetConnection = "error-alert-no-internet-connection"
